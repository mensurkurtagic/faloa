<?php /* Smarty version Smarty-3.1.12, created on 2018-10-14 23:24:56
         compiled from "C:\xampp\htdocs\faloa\themes\Backend\ExtJs\backend\customer\controller\stream.js" */ ?>
<?php /*%%SmartyHeaderCode:9549590435bc3b428df71f4-69216459%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c48dae9f360fa6a4af921f13a89a41cda48a42fc' => 
    array (
      0 => 'C:\\xampp\\htdocs\\faloa\\themes\\Backend\\ExtJs\\backend\\customer\\controller\\stream.js',
      1 => 1537274534,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9549590435bc3b428df71f4-69216459',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5bc3b428e88b75_95047329',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bc3b428e88b75_95047329')) {function content_5bc3b428e88b75_95047329($_smarty_tpl) {?>/**
 * Shopware 5
...
', next.get('name'), total - streams.length, total),
    ...
    checkIndexState: function() {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/faloa/backend/CustomerStream/getNotIndexedCount';?>',
...
<?php $_tmp9=ob_get_clean();?><?php if (!$_tmp9){?>*/
        ...
        Ext.Ajax.request({
            url: '<?php echo '/faloa/backend/CustomerStream/loadStream';?>',
            params: {
            ...
            success: function(operation) {
                ...
                me.start(
                    [{
                        url: '<?php echo '/faloa/backend/CustomerStream/indexStream';?>',
                        params: {
...
<?php $_tmp10=ob_get_clean();?><?php if (!$_tmp10){?>*/
        ...
        me.getSearchIndexingParameters(force, function(params) {
            me.start(
                [{
                    url: '<?php echo '/faloa/backend/CustomerStream/buildSearchIndex';?>',
                    params: params
                }],
                callback
            );
    ...
    getSearchIndexingParameters: function(force, callback) {
        Ext.Ajax.request({
            ...
            success: function(operation) {
                ...
                Ext.Ajax.request({
                    url: '<?php echo '/faloa/backend/CustomerStream/getCustomerCount';?>',
                    params: {},
                    success: function (operation) {
    ...
    resetProgressbar: function () {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/faloa/backend/CustomerStream/getLastFullIndexTime';?>',
            success: function(operation) {
                var response = Ext.decode(operation.responseText);
                Ext.defer(function () {
