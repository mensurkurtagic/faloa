<?php /* Smarty version Smarty-3.1.12, created on 2018-10-14 23:24:55
         compiled from "C:\xampp\htdocs\faloa\themes\Backend\ExtJs\backend\article_list\controller\batch_process.js" */ ?>
<?php /*%%SmartyHeaderCode:12801441115bc3b427ce3509-17569262%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '88d93bd5eb3399fda360a286f31432ce2903e11f' => 
    array (
      0 => 'C:\\xampp\\htdocs\\faloa\\themes\\Backend\\ExtJs\\backend\\article_list\\controller\\batch_process.js',
      1 => 1537274534,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '12801441115bc3b427ce3509-17569262',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5bc3b427d2e834_76504765',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bc3b427d2e834_76504765')) {function content_5bc3b427d2e834_76504765($_smarty_tpl) {?>/**
 * Shopware 5
...
');
    ...
    addToQueue: function(config, offset, queueId, startTime) {
        ...
        Ext.Ajax.request({
            type: "POST",
            url: '<?php echo '/faloa/backend/ArticleList/createQueue';?>',
            timeout: 4000000,
            params : {
                resource: 'product',
...
');
    ...
    runBatchProcess: function(queueId, config, startTime) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/faloa/backend/ArticleList/batch';?>',
            timeout: 4000000,
            params : {
                resource: 'product',
                limit: 200,
