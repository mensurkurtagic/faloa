<?php /* Smarty version Smarty-3.1.12, created on 2018-10-14 23:24:55
         compiled from "C:\xampp\htdocs\faloa\themes\Backend\ExtJs\backend\product_stream\controller\main.js" */ ?>
<?php /*%%SmartyHeaderCode:7203351105bc3b427b79895-97615784%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e4fb23ddd3a7d4ba2e1e054fb5cac0516dec27ac' => 
    array (
      0 => 'C:\\xampp\\htdocs\\faloa\\themes\\Backend\\ExtJs\\backend\\product_stream\\controller\\main.js',
      1 => 1537274534,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7203351105bc3b427b79895-97615784',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5bc3b427badfb8_32423486',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bc3b427badfb8_32423486')) {function content_5bc3b427badfb8_32423486($_smarty_tpl) {?>/**
 * Shopware 5
                ...
                duplicatedRecord.save({
                    success: function (newRecord) {
                        if (newRecord.get('type') == 2) {
                            Ext.Ajax.request({
                                url: '<?php echo '/faloa/backend/ProductStream/copySelectedProducts';?>',
                                params: {
                        ...
                        Ext.Ajax.request({
                            url: '<?php echo '/faloa/backend/ProductStream/copyStreamAttributes';?>',
                            params: {
                                sourceStreamId: record.get('id'),
                                targetStreamId: newRecord.get('id')
                            }
