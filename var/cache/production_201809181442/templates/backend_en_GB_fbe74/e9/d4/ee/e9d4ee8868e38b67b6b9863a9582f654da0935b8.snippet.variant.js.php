<?php /* Smarty version Smarty-3.1.12, created on 2018-10-14 23:24:58
         compiled from "C:\xampp\htdocs\faloa\themes\Backend\ExtJs\backend\article\controller\variant.js" */ ?>
<?php /*%%SmartyHeaderCode:17386973165bc3b42ac01207-90843437%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e9d4ee8868e38b67b6b9863a9582f654da0935b8' => 
    array (
      0 => 'C:\\xampp\\htdocs\\faloa\\themes\\Backend\\ExtJs\\backend\\article\\controller\\variant.js',
      1 => 1537274534,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17386973165bc3b42ac01207-90843437',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5bc3b42acc0313_72838039',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bc3b42acc0313_72838039')) {function content_5bc3b42acc0313_72838039($_smarty_tpl) {?>/**
 * Shopware 5
...
'
    ...
    onLoadConfiguratorSet: function(newConfiguratorSet, window) {
        ...
        if (listing.getStore() && listing.getStore().getCount() > 0) {
            Ext.MessageBox.confirm(me.snippets.messages.warningTitle, me.snippets.messages.loadSetWarning, function (response) {
                if ( response === 'yes' ) {
                    Ext.Ajax.request({
                        url:'<?php echo '/faloa/backend/Article/deleteAllVariants';?>',
                        params:{
                            articleId: me.subApplication.article.get('id')
                        },
                        success: function(record, operation) {
    ...
    */
    ...
    generateNumbers: function(offset, window, totalCount, batchSize, progressbar) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/faloa/backend/Article/regenerateVariantOrderNumbers';?>',
            method: 'POST',
            params: {
                articleId: me.subApplication.article.get('id'),
                offset: offset,
