<?php /* Smarty version Smarty-3.1.12, created on 2018-10-14 23:24:59
         compiled from "C:\xampp\htdocs\faloa\themes\Backend\ExtJs\backend\article\controller\esd.js" */ ?>
<?php /*%%SmartyHeaderCode:14484662245bc3b42b3d83f1-75801962%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0bd5e0fe9ac4704d3cd57016f78351f719bf237f' => 
    array (
      0 => 'C:\\xampp\\htdocs\\faloa\\themes\\Backend\\ExtJs\\backend\\article\\controller\\esd.js',
      1 => 1537274534,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14484662245bc3b42b3d83f1-75801962',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5bc3b42b425042_75730956',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bc3b42b425042_75730956')) {function content_5bc3b42b425042_75730956($_smarty_tpl) {?>/**
 * Shopware 5
...
'
    ...
    onAddEsd: function(articleDetailId) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/faloa/backend/Article/createEsd';?>',
            method: 'POST',
            params: {
    ...
    saveNewSerials: function(serials) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/faloa/backend/Article/saveSerials';?>',
            method: 'POST',
            params: {
    ...
    onDeleteUnusedSerials: function() {
        ...
        Ext.MessageBox.confirm(me.snippets.growlMessage, me.snippets.messages.serialsRemoveUnused , function (response) {
            ...
            Ext.Ajax.request({
                url: '<?php echo '/faloa/backend/Article/deleteUnusedSerials';?>',
                method: 'POST',
                params: {
                    esdId: me.detailWindow.esdRecord.get('id')
                },
    ...
    onDownloadFile: function() {
        ...
        var url = '<?php echo '/faloa/backend/Article/getEsdDownload';?>' + '/filename/' + record.get('file');
