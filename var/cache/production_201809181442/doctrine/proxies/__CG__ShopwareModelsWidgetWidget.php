...
namespace Shopware\Proxies\__CG__\Shopware\Models\Widget;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Widget extends \Shopware\Models\Widget\Widget implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Shopware\\Models\\Widget\\Widget' . "\0" . 'id', '' . "\0" . 'Shopware\\Models\\Widget\\Widget' . "\0" . 'name', '' . "\0" . 'Shopware\\Models\\Widget\\Widget' . "\0" . 'views', '' . "\0" . 'Shopware\\Models\\Widget\\Widget' . "\0" . 'pluginId', '' . "\0" . 'Shopware\\Models\\Widget\\Widget' . "\0" . 'plugin'];
        }
